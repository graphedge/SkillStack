...
MUST NOT run the Board sequence or the proposal template below. MUST NOT escalate routine work into a Board play. Bounded suggestions use Change proposal in [board/workflow.md](../board/workflow.md) (suggest-only). Unnamed lanes are locked.
