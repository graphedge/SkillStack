...
- **Change proposal (MUST):** Bounded suggestions use Change proposal in [board/workflow.md](board/workflow.md) (suggest-only). Unnamed lanes are locked; lane choice lives in workflow.md.
